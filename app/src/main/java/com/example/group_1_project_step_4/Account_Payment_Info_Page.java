...
public class Account_Payment_Info_Page extends AppCompatActivity {
    ...
    private String userName, address, emailAddress, phoneNumber, cardNumber, cardType, cardExpiry, billAddress;
    ...
    public void submit(View view) {
        ...
        if (!checkEmpty(userName)) {
            ...
            error++;
        } else if (!checkEmpty(cardType)) {
            error = 0;
            toastMessage("Please select a card type");
            error++;
